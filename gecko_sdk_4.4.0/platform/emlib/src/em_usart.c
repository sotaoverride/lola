 ...
 ******************************************************************************/
static void
prsRxInput (USART_TypeDef *usart, USART_PRS_Channel_t ch)
{
 ...
 ******************************************************************************/
static void
prsTriggerInput (USART_TypeDef *usart, USART_PRS_Channel_t ch)
{
 ...
 ******************************************************************************/
void
USART_BaudrateAsyncSet (USART_TypeDef *usart, uint32_t refFreq,
 ...
 ******************************************************************************/
uint32_t
USART_BaudrateCalc (uint32_t refFreq, uint32_t clkdiv,
bool syncmode,
 ...
 ******************************************************************************/
void
USART_BaudrateSyncSet (USART_TypeDef *usart, uint32_t refFreq,
                       uint32_t baudrate)
{
  uint32_t clkdiv;
...
USART_InitAsync (USART_TypeDef *usart, const USART_InitAsync_TypeDef *init)
{
  ...
  if ((init->hwFlowControl == usartHwFlowControlRts)
    ...
    {
#if USART_COUNT > 1
      GPIO->USARTROUTE_SET[USART_NUM(usart)].ROUTEEN =
    ...
    {
#if USART_COUNT > 1
      GPIO->USARTROUTE_CLR[USART_NUM(usart)].ROUTEEN =
          GPIO_USART_ROUTEEN_RTSPEN;
#else
    //! @todo cleanup when ADM is updated to have USART_NUM macros
 ...
 ******************************************************************************/
void
USART_InitI2s (USART_TypeDef *usart, USART_InitI2s_TypeDef *init)
{
 ...
 ******************************************************************************/
void
USART_InitPrsTrigger (USART_TypeDef *usart,
